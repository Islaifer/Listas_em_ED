...
//Esta classe é o menu da lista simplesmente encadeada
public class MenuListaSimplesmenteEncadeada {
	private int opc;
	
	public MenuListaSimplesmenteEncadeada() {
		opc = 0;
	}
	
	public ListaSimplesmenteEncadeada menu(ListaSimplesmenteEncadeada lista) {
		int pos;
		while(this.opc!=9) {
			this.opc = Integer.parseInt(JOptionPane.showInputDialog("Menu da lista simplesmente"
					+ " encadeada:\n"
					+ "1-Adicionar Final\n"
					+ "2-Adicionar Inicio\n"
					+ "3-Adicionar Meio\n"
